...
export default function StageFive() {
  ...
  return (  
    <MobileLayout title="Inspection Stage 5" backgroundColor={'#000'}>
            ...
            <div className="small fw-bold">Underbody </div>
                {
                    ...
                    <Box item xs={4} sx={{ display: `${selectedBodyId === carBody.id ? 'flex' : 'none'}`, boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.16)', padding: '8px', alignItems: 'center', justifyContent: 'flex-end' }} >
                ...
                <div className="small fw-bold">Underhood</div>
                    {
                        ...
                        <Box item xs={4} sx={{ display: `${selectedHoodId === carHood.id ? 'flex' : 'none'}`, boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.16)', padding: '8px', alignItems: 'center', justifyContent: 'flex-end' }} >
                            <Box onClick={() => router.push('/inspection/stages/upload-stage')} sx={{ color: '#243773', fontSize: '12px', fontWeight: 600, cursor: 'pointer' }}>Preview</Box>
                        </Box>
                        </div>
                        ))
