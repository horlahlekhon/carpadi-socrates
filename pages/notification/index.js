...
export default function NotificationIndex() {
    ...
    return(
        <InspectionLayout activeNav={2} title="notification" backgroundColor={'#000'} 
        topbar={<SubNavBar header="Notification" removeIcon="none"/>} bodyHeight="81.5vh">
                ...
                <Grid container >
                    ...
                    <Grid item xs={10}>
                        ...
                        <Typography variant="body2" sx={{ml: 1, fontSize: '12px'}}>carpadi- Inspection</Typography>
                            ...
                            <Button onClick={() => router.push(`/notification/inspection/${message.id}`)} variant="text" style={{display: "block",float: "right", textTransform: 'capitalize'}}>View details</Button>
                        </Box>
                    </Grid>
                </Grid>
